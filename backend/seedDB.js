...
const cmsPages = [
  {
    ...
    slug: 'about',
    content: `
      <h1>About SajiloBasai</h1>
      <p>Welcome to SajiloBasai, Nepal's premier platform for finding rooms, flats, and apartments.</p>
...
const blogPosts = [
  {
    ...
    author: {
      name: 'SajiloBasai Team',
      email: 'team@sajilobasai.com',
    },
    status: 'published',
    publishedAt: new Date(),
    featuredImage:
...
const seedDatabase = async () => {
  try {
    ...
    console.log('\nSample accounts:');
    console.log('Admin: admin@sajilobasai.com / admin123');
