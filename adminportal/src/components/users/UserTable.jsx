  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmDialog
        ...
        title="Delete User"
        message={`Are you sure you want to delete ${selectedUser?.name}? This action cannot be undone and will remove all user data including their properties and bookings.`}
        isDark={isDark}
