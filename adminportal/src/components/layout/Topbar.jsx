      ...
      <div className="flex items-center space-x-2">
          ...
          {showNotifications && (
            ...
            `}>
              ...
              <div className={`px-6 py-4 border-t ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
                <button className={`w-full text-sm font-medium transition-colors ${isDark ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-800'}`}>
        ...
        <div className="relative">
          ...
          >
            ...
            <FiMoreVertical className={`w-4 h-4 ${isDark ? 'text-gray-400' : 'text-gray-600'} hidden sm:block`} />
          </button>
