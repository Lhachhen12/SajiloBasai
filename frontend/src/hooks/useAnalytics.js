...
export const useEventTracking = () => {
  return {
    ...
    trackBookingStart: (propertyId, bookingData) => {
      analytics.trackBookingStart(propertyId, bookingData);
    },
    trackBookingComplete: (propertyId, bookingData) => {
      analytics.trackBookingComplete(propertyId, bookingData);
    },
