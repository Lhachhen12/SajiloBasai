          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-12 bg-white flex flex-col justify-center">
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                SajiloBasai is transforming how people find homes across Nepal. We're leveraging modern technology and deep local insights to deliver a seamless property experience.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Whether you're a student, a family, or a landlord, SajiloBasai helps you find or list properties efficiently and securely.
              </p>
            </div>
          </div>
        </div>
