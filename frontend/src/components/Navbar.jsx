...
import { FaUser, FaHome, FaBars, FaTimes, FaSignOutAlt, FaHeart, FaBookmark, FaList, FaPlus } from 'react-icons/fa';
              ...
              >
                ...
                {isBuyer && (
                  <div className="py-2">
                    ...
                    <Link to="/buyer/bookings" className="dropdown-item">
          ...
          <div className="p-6">
            <div className="flex justify-between items-center mb-6">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-primary-600">SajiloBasai</span>
              </Link>
              <button
                onClick={() => setIsMenuOpen(false)}
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    ...
                    {isBuyer && (
                      <>
                        ...
                        <Link 
                          to="/buyer/bookings" 
                          className={`block py-2 ${isActive('/buyer/bookings') ? 'text-primary-600 font-medium' : 'text-gray-700 hover:text-primary-600'}`}
                          onClick={() => setIsMenuOpen(false)}
                        >
                          My Bookings
                        </Link>
