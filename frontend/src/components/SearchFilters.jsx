...
import { Search, MapPin, Home, ChevronDown, ChevronUp, Sliders } from 'lucide-react';
  ...
  if (layout === 'horizontal') {
    ...
    <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 max-w-4xl mx-auto">
      ...
      <div className="space-y-1.5">
        <label htmlFor="location-h" className="block text-sm font-semibold text-gray-700">
          Location
        </label>
      ...
      {/* Property Type */}
      <div className="space-y-1.5">
        <label htmlFor="type-h" className="block text-sm font-semibold text-gray-700">
          Property Type
        </label>
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
      ...
      <div className="mt-3 pt-3 border-t border-gray-200 animate-in slide-in-from-top-2 duration-300">
        ...
        <div className="mb-3">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-md p-2 mb-3">
            <div className="text-xs font-medium text-blue-700 mb-1">Popular Price Ranges</div>
        ...
        {isAdvancedOpen && (
          <div className="space-y-4 animate-in slide-in-from-top-2 duration-300">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Min Price */}
              <div className="space-y-2">
                <label htmlFor="minPrice" className="block text-sm font-semibold text-gray-700">
                  Min Price
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              {/* Max Price */}
              <div className="space-y-2">
                <label htmlFor="maxPrice" className="block text-sm font-semibold text-gray-700">
                  Max Price
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
